...
var DocumentFactory = func() common.ISODocument {
	return &AccountDebitCreditNotification_camt_054_001_08.Document{
...
var RequireFileds = []string{
	...
	"TransactionDetailRefer.MessageIdentification",
...
var PathMap = map[string]any{
	...
	"BkToCstmrDbtCdtNtfctn.Ntfctn.Ntry.NtryDtls.TxDtls.Refs.MsgId":                                            "TransactionDetailRefer.MessageIdentification",

...
func MergeXML(
	...
	msgModel := &MessageModel{
		AppHdr:                   *headerModel,
		ParticipantPaymentStatus: *dataModel,
	}
...
func TestCreateJson(t *testing.T) {
	var moduleName = "ParticipantBroadcast"
	var headerSamplePath = "../head_001_001_02/swiftSample"
	var bodySamplePath = "../ParticipantPaymentStatus_pacs_002_001_10/swiftSample"
...
func TestCreateDocument(t *testing.T) {
	wrapper := &MessageParticipantPaymentStatusWrapper{}
	/*Valid documents*/

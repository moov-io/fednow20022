...
func (v Document) Validate() error {
	...
	baseName := "Document"
	fednow.AddError(&errs, baseName+".UblToApply", v.UblToApply.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v MissingOrIncorrectInformation31) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "MissingOrIncorrectInformation31"
	if v.AMLReq != nil {
		fednow.AddError(&errs, baseName+".AMLReq", v.AMLReq.Validate())
	}
	if v.MssngInf != nil {
		for indx := range v.MssngInf {
			fednow.AddError(&errs, baseName+".MssngInf", v.MssngInf[indx].Validate())
		}
	}
	if v.IncrrctInf != nil {
		for indx := range v.IncrrctInf {
			fednow.AddError(&errs, baseName+".IncrrctInf", v.IncrrctInf[indx].Validate())
		}
	}
	if errs.Empty() {
		return nil
...
func (v UnableToApplyIncorrect11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnableToApplyIncorrect11"
	fednow.AddError(&errs, baseName+".Cd", v.Cd.Validate())
	if v.AddtlIncrrctInf != nil {
		fednow.AddError(&errs, baseName+".AddtlIncrrctInf", v.AddtlIncrrctInf.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v UnableToApplyJustification3Choice1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnableToApplyJustification3Choice1"
	if v.MssngOrIncrrctInf != nil {
		fednow.AddError(&errs, baseName+".MssngOrIncrrctInf", v.MssngOrIncrrctInf.Validate())
	}
	if v.PssblDplctInstr != nil {
		fednow.AddError(&errs, baseName+".PssblDplctInstr", v.PssblDplctInstr.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v UnableToApplyMissing11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnableToApplyMissing11"
	fednow.AddError(&errs, baseName+".Cd", v.Cd.Validate())
	if v.AddtlMssngInf != nil {
		fednow.AddError(&errs, baseName+".AddtlMssngInf", v.AddtlMssngInf.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v UnableToApplyV07) Validate() error {
	...
	fednow.AddError(&errs, baseName+".Case", v.Case.Validate())
	fednow.AddError(&errs, baseName+".Undrlyg", v.Undrlyg.Validate())
	fednow.AddError(&errs, baseName+".Justfn", v.Justfn.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v UnderlyingPaymentInstruction51) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingPaymentInstruction51"
	...
	fednow.AddError(&errs, baseName+".OrgnlInstdAmt", v.OrgnlInstdAmt.Validate())
...
func (v UnderlyingPaymentTransaction41) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingPaymentTransaction41"
	fednow.AddError(&errs, baseName+".OrgnlGrpInf", v.OrgnlGrpInf.Validate())
	if v.OrgnlInstrId != nil {
		fednow.AddError(&errs, baseName+".OrgnlInstrId", v.OrgnlInstrId.Validate())
	}
...
func (v UnderlyingTransaction5Choice1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction5Choice1"
	if v.Initn != nil {
		fednow.AddError(&errs, baseName+".Initn", v.Initn.Validate())
	}
	if v.IntrBk != nil {
		fednow.AddError(&errs, baseName+".IntrBk", v.IntrBk.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v UnableToApplyIncorrectInformation4Code1) Validate() error {
	if err := fednow.ValidateEnumeration(string(v), "IN02", "IN03", "IN06", "IN07", "IN08", "IN13", "IN14", "IN15", "IN16", "MM20", "MM21", "MM25", "MM26", "MM27", "MM28", "MM29", "MM30", "MM31", "MM32", "MM35", "IN38", "IN39", "NARR"); err != nil {
		return err
	}
	return nil
}
...
func (v UnableToApplyMissingInformation3Code1) Validate() error {
	if err := fednow.ValidateEnumeration(string(v), "MS01", "NARR"); err != nil {
		return err
	}
	return nil
}

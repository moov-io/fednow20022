...
type CaseAssignment51 struct {
	Id      MessageIdentificationFedNow1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 Id"`
...
type CorrectiveGroupInformation11 struct {
	MsgId   Max35Text                     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 MsgId"`
	MsgNmId MessageNameIdentificationFRS1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 MsgNmId"`
	CreDtTm fednow.ISODateTime            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 CreDtTm"`
}

type CorrectiveInterbankTransaction21 struct {
	GrpHdr         CorrectiveGroupInformation11   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 GrpHdr"`
	...
	IntrBkSttlmAmt ActiveCurrencyAndAmountFedNow1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 IntrBkSttlmAmt"`
	IntrBkSttlmDt  fednow.ISODate                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 IntrBkSttlmDt"`
}

type CorrectiveTransaction4Choice1 struct {
	IntrBk *CorrectiveInterbankTransaction21 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 IntrBk,omitempty"`
}
...
type ResolutionOfInvestigationV09 struct {
	...
	CrrctnTx     *CorrectiveTransaction4Choice1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 CrrctnTx,omitempty"`

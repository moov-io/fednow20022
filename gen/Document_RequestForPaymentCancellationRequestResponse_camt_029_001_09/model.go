...
type Message struct {
	...
	RequestForPaymentCancellationRequestResponse *RequestForPaymentCancellationRequestResponse_camt_029_001_09.Document `xml:"urn:fednow RequestForPaymentCancellationRequestResponse,omitempty"`
}

var NamespacePrefixMap = map[string]string{
	"urn:iso:std:iso:20022:tech:xsd:head.001.001.01": "head",
	"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09": "rfpcrr",
}

func (v *Message) Body() interface{} {
	if v.RequestForPaymentCancellationRequestResponse != nil {
		return v.RequestForPaymentCancellationRequestResponse
	}
	return nil
}

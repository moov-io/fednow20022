...
func (w *MessageAccountActivityDetailsReportWrapper) CreateDocument(modelJson []byte) ([]byte, error) {
	...
	dataDoc, err := common.DocumentWith(model.AccountBalanceReport, BodyPathMap, BodyDocumentFactory)
	if err != nil {
...
func (w *MessageAccountActivityDetailsReportWrapper) CheckRequireField(modelJson []byte) error {
	...
	dataJson, err := json.Marshal(model.AccountBalanceReport)
	if err != nil {
...
func (w *MessageAccountActivityDetailsReportWrapper) GetDataModel(xmlData []byte) (modelJson []byte, err error) {
	...
	bodyModelModel, err := common.MessageModelWith(doc.AccountBalanceReport, BodyDataFactory, BodyPathMap)
	if err != nil {
		return nil, err
	}

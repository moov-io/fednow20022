...
func MergeXML(
	...
	msgModel := &MessageModel{
		AppHdr:                       *headerModel,
		AdditionalPaymentInformation: *dataModel,
	}
...
func TestCreateJson(t *testing.T) {
	var moduleName = "AccountReportingRequest"
	var headerSamplePath = "../head_001_001_02/swiftSample"
	var bodySamplePath = "../AdditionalPaymentInformation_camt_028_001_09/swiftSample"
...
func TestCreateDocument(t *testing.T) {
	wrapper := &MessageAdditionalPaymentInformationWrapper{}
	/*Valid documents*/

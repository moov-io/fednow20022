...
func MergeXML(
	...
	msgModel := &MessageModel{
		AppHdr:               *headerModel,
		FedNowSystemResponse: *dataModel,
	}
...
func TestCreateJson(t *testing.T) {
	var moduleName = "FedNowParticipantFile"
	var headerSamplePath = "../head_001_001_02/swiftSample"
	var bodySamplePath = "../FedNowSystemResponse_admi_011_001_01/swiftSample"
...
func TestCreateDocument(t *testing.T) {
	wrapper := &MessageFedNowSystemResponseWrapper{}
	/*Valid documents*/

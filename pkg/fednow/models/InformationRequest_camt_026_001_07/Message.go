...
var DocumentFactory = func() common.ISODocument {
	return &camt_026_001_07.Document{
...
var PathMap = map[string]any{
	...
	"UblToApply.Undrlyg.Initn.OrgnlPmtInfId":            "Initiation.OriginalTransactionDetail.TransactionId",
	...
	"UblToApply.Undrlyg.IntrBk.OrgnlTxId":                 "Interbank.OriginalTransactionDetail.TransactionId",

...
func (v CorrectiveGroupInformation11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CorrectiveGroupInformation11"
...
func (v CorrectiveInterbankTransaction21) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CorrectiveInterbankTransaction21"
...
func (v CorrectiveTransaction4Choice1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CorrectiveTransaction4Choice1"
	if v.IntrBk != nil {
...
func (v ResolutionOfInvestigationV09) Validate() error {
	...
	if v.CrrctnTx != nil {
		fednow.AddError(&errs, baseName+".CrrctnTx", v.CrrctnTx.Validate())
	}

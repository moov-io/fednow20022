...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.055.001.09
...
func (v Document) Validate() error {
	...
	baseName := "Document"
	fednow.AddError(&errs, baseName+".CstmrPmtCxlReq", v.CstmrPmtCxlReq.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v CustomerPaymentCancellationRequestV09) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CustomerPaymentCancellationRequestV09"
...
func (v OriginalPaymentInstruction361) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction361"
...
func (v PaymentTransaction1241) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction1241"
	...
	fednow.AddError(&errs, baseName+".OrgnlReqdExctnDt", v.OrgnlReqdExctnDt.Validate())
	fednow.AddError(&errs, baseName+".CxlRsnInf", v.CxlRsnInf.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v UnderlyingTransaction271) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction271"
	fednow.AddError(&errs, baseName+".OrgnlPmtInfAndCxl", v.OrgnlPmtInfAndCxl.Validate())
	if errs.Empty() {
		return nil
	}
	return errs

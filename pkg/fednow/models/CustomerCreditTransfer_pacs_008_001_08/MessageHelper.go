...
type MessageHelper struct {
	...
	PurposeCode                  common.ElementHelper
	RemittanceInformation        common.RemittanceInformationHelper
	RelatedRemittanceInformation common.RelatedRemittanceInformationHelper
}
...
func BuildMessageHelper() MessageHelper {
	return MessageHelper{
		...
		ChargeBearer: common.ElementHelper{
			...
			Documentation: `Specifies who will bear the charges related to the transaction.`,
		},
		...
		PurposeCode: common.ElementHelper{
			Title:         "Purpose Code",
			Rules:         "",
			Type:          `ExternalPurposeCode (based on string) minLength: 1 max Length: 4`,
			Documentation: `Code that specifies the purpose of the transaction.`,
		},
		RemittanceInformation:        common.BuildRemittanceInformationHelper(),
		RelatedRemittanceInformation: common.BuildRelatedRemittanceInformationHelper(),
	}

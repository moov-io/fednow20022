...
type Message struct {
	...
	RequestForPaymentCancellationRequestResponse *RequestForPaymentCancellationRequest_camt_055_001_09.Document `xml:"urn:fednow RequestForPaymentCancellationRequestResponse,omitempty"`
}

var NamespacePrefixMap = map[string]string{
	"urn:iso:std:iso:20022:tech:xsd:head.001.001.01": "head",
	"urn:iso:std:iso:20022:tech:xsd:camt.055.001.09": "rfpcr",
}

...
func (v Document) Validate() error {
	...
	baseName := "Document"
	fednow.AddError(&errs, baseName+".CdtrPmtActvtnReq", v.CdtrPmtActvtnReq.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v CreditTransferTransaction351) Validate() error {
	...
	if v.PmtCond != nil {
		fednow.AddError(&errs, baseName+".PmtCond", v.PmtCond.Validate())
	}
...
func (v CreditorPaymentActivationRequestV07) Validate() error {
	...
	fednow.AddError(&errs, baseName+".PmtInf", v.PmtInf.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v PaymentCondition11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentCondition11"
	fednow.AddError(&errs, baseName+".AmtModAllwd", v.AmtModAllwd.Validate())
	fednow.AddError(&errs, baseName+".EarlyPmtAllwd", v.EarlyPmtAllwd.Validate())
	fednow.AddError(&errs, baseName+".GrntedPmtReqd", v.GrntedPmtReqd.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v PaymentInstruction311) Validate() error {
	...
	fednow.AddError(&errs, baseName+".PmtInfId", v.PmtInfId.Validate())
	fednow.AddError(&errs, baseName+".PmtMtd", v.PmtMtd.Validate())
	fednow.AddError(&errs, baseName+".ReqdExctnDt", v.ReqdExctnDt.Validate())
	fednow.AddError(&errs, baseName+".XpryDt", v.XpryDt.Validate())
	...
	fednow.AddError(&errs, baseName+".CdtTrfTx", v.CdtTrfTx.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v PaymentMethod7Code1) Validate() error {
	if err := fednow.ValidateEnumeration(string(v), "TRF"); err != nil {
		return err
	}
	return nil
}

...
func MergeXML(
	...
	msgModel := &MessageModel{
		AppHdr:                     *headerModel,
		InformationRequestResponse: *dataModel,
	}
...
func TestCreateJson(t *testing.T) {
	var moduleName = "InformationRequest"
	var headerSamplePath = "../head_001_001_02/swiftSample"
	var bodySamplePath = "../InformationRequestResponse_camt_029_001_09/swiftSample"
...
func TestCreateDocument(t *testing.T) {
	wrapper := &MessageInformationRequestResponseWrapper{}
	/*Valid documents*/

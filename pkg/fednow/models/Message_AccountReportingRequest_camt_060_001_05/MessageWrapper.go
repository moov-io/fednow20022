...
// type MessageAccountReportingRequestWrapper struct{}

// func (w *MessageAccountReportingRequestWrapper) CreateDocument(modelJson []byte) ([]byte, error) {
...
// 	dataDoc, err := common.DocumentWith(model.AccountReportingRequest, BodyPathMap, BodyDocumentFactory)
// 	if err != nil {
...
// func (w *MessageAccountReportingRequestWrapper) ValidateDocument(modelJson []byte) error {
// 	var model MessageModel
// 	if err := json.Unmarshal(modelJson, &model); err != nil {
...
// func (w *MessageAccountReportingRequestWrapper) CheckRequireField(modelJson []byte) error {
// 	var model MessageModel
// 	if err := json.Unmarshal(modelJson, &model); err != nil {
// 		return fmt.Errorf("failed to unmarshal JSON: %w", err)
// 	}
...
// 	dataJson, err := json.Marshal(model.AccountReportingRequest)
// 	if err != nil {
...
// func (w *MessageAccountReportingRequestWrapper) GetDataModel(xmlData []byte) (modelJson []byte, err error) {
// 	var doc GeneratedMsgType
...
// 		return nil, err
// 	}
// 	bodyModelModel, err := common.MessageModelWith(doc.AccountReportingRequest, BodyDataFactory, BodyPathMap)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (w *MessageAccountReportingRequestWrapper) GetHelp() ([]byte, error) {
// 	helper := BuildHelper()

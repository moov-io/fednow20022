...
func (v Document) Validate() error {
	...
	baseName := "Document"
	fednow.AddError(&errs, baseName+".AddtlPmtInf", v.AddtlPmtInf.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v AdditionalPaymentInformationV09) Validate() error {
	...
	fednow.AddError(&errs, baseName+".Inf", v.Inf.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v FinancialInstitutionIdentification183) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FinancialInstitutionIdentification183"
	if v.BICFI != nil {
		fednow.AddError(&errs, baseName+".BICFI", v.BICFI.Validate())
	}
...
func (v PartyIdentification1354) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PartyIdentification1354"
	fednow.AddError(&errs, baseName+".Nm", v.Nm.Validate())
	if v.PstlAdr != nil {
		fednow.AddError(&errs, baseName+".PstlAdr", v.PstlAdr.Validate())
	}
...
func (v PaymentComplementaryInformation81) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentComplementaryInformation81"
	if v.InstrId != nil {
...
func (v ExternalClearingSystemIdentification1Code) Validate() error {
	...
	if err := fednow.ValidateMaxLength(string(v), 5); err != nil {
		return err
	}
	return nil
}

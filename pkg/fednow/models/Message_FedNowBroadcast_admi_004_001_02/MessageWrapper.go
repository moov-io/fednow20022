...
// type MessageFedNowBroadcastWrapper struct{}

// func (w *MessageFedNowBroadcastWrapper) CreateDocument(modelJson []byte) ([]byte, error) {
...
// 	dataDoc, err := common.DocumentWith(model.FedNowBroadcast, BodyPathMap, BodyDocumentFactory)
// 	if err != nil {
...
// func (w *MessageFedNowBroadcastWrapper) ValidateDocument(modelJson []byte) error {
// 	var model MessageModel
// 	if err := json.Unmarshal(modelJson, &model); err != nil {
...
// func (w *MessageFedNowBroadcastWrapper) CheckRequireField(modelJson []byte) error {
// 	var model MessageModel
// 	if err := json.Unmarshal(modelJson, &model); err != nil {
// 		return fmt.Errorf("failed to unmarshal JSON: %w", err)
// 	}
...
// 	dataJson, err := json.Marshal(model.FedNowBroadcast)
// 	if err != nil {
...
// func (w *MessageFedNowBroadcastWrapper) GetDataModel(xmlData []byte) (modelJson []byte, err error) {
// 	var doc GeneratedMsgType
...
// 		return nil, err
// 	}
// 	bodyModelModel, err := common.MessageModelWith(doc.FedNowBroadcast, BodyDataFactory, BodyPathMap)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (w *MessageFedNowBroadcastWrapper) GetHelp() ([]byte, error) {
// 	helper := BuildHelper()

...
type CaseAssignment51 struct {
	Id      MessageIdentificationFedNow1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 Id"`
	...
	CreDtTm fednow.ISODateTime           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 CreDtTm"`
}
...
type Contact41 struct {
	...
	PrefrdMtd PreferredContactMethod1Code1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 PrefrdMtd"`
}

type DateAndPlaceOfBirth1 struct {
	BirthDt     fednow.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 BirthDt"`
...
type OriginalGroupInformation291 struct {
	...
	OrgnlCreDtTm fednow.ISODateTime            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 OrgnlCreDtTm"`
}
...
type PartyIdentification1351 struct {
	...
	CtctDtls *Contact41      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 CtctDtls,omitempty"`
}

type PaymentCancellationReason51 struct {
	Orgtr    *PartyIdentification1351    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 Orgtr,omitempty"`
...
type PaymentTransaction1061 struct {
	...
	OrgnlIntrBkSttlmAmt ActiveOrHistoricCurrencyAndAmountFedNow1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 OrgnlIntrBkSttlmAmt"`
	OrgnlIntrBkSttlmDt  fednow.ISODate                           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 OrgnlIntrBkSttlmDt"`

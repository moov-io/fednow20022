...
func MergeXML(
	...
	msgModel := &MessageModel{
		AppHdr:                         *headerModel,
		AccountDebitCreditNotification: *dataModel,
	}
...
func TestCreateJson(t *testing.T) {
	var moduleName = "AccountDebitCreditNotification"
	var headerSamplePath = "../head_001_001_02/swiftSample"
	var bodySamplePath = "../AccountDebitCreditNotification_camt_054_001_08/swiftSample"
...
func TestCreateDocument(t *testing.T) {
	wrapper := &Message_AccountDebitCreditNotificationWrapper{}
	/*Valid documents*/

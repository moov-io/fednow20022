...
type DateAndDateTime2Choice1 struct {
	Dt *fednow.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10 Dt,omitempty"`
}
...
type PaymentTransaction1101 struct {
	...
	AccptncDtTm       *fednow.ISODateTime                           `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10 AccptncDtTm,omitempty"`
...
type StatusReasonInformation121 struct {
	...
	Rsn      StatusReason6Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10 Rsn"`
